...
const AdminLeftBar = () => {
  ...
  const Linksdata = [
    ...
    { title: 'Queries', path: '/admin/queries' },
  ];
    ...
    <div className="w-full h-full bg-gradient-to-b from-gray-800 via-gray-900 to-black shadow-xl flex justify-center items-center">
      <div className="h-full w-full flex flex-col">
        ...
        <div
                ...
                className="flex items-center cursor-pointer pl-6 pt-3"
                onClick={() => navigate('/')}
            >
        ...
        <div className="font-bold mt-4">
          <div className="h-[80%] w-full flex flex-col items-center gap-4">
            {Linksdata.map((link, index) => (
              <NavLink
                to={link.path}
                key={index}
                className={({ isActive }) =>
                  `px-6 py-2 w-[80%] text-center rounded-lg transition-transform duration-200 ${
                    isActive
