...
const LoadingScreen = () => {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-black">
            ...
            <div className="flex items-center cursor-pointer mb-4 opacity-90">
            ...
            {/* Smaller Loading Bar with Right Margin */}
            <div className='ml-1.5'>
                <div className="w-[180px] h-[8px] bg-gray-300 rounded-lg relative overflow-hidden mt-4 mr-4">
